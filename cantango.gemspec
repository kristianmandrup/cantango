...
Store permissions in yaml file or key-value store}
  ...
  s.files = [
    ...
    "lib/cantango/ability/cache_key.rb",
    "lib/cantango/ability/helper.rb",
    "lib/cantango/ability/helper/account.rb",
    "lib/cantango/ability/helper/cache.rb",
    "lib/cantango/ability/helper/engine.rb",
    "lib/cantango/ability/helper/masquerade.rb",
    "lib/cantango/ability/helper/permit.rb",
    "lib/cantango/ability/helper/permit_store.rb",
    ...
    "lib/cantango/ability_executor/base.rb",
    "lib/cantango/ability_executor/cached.rb",
    "lib/cantango/ability_executor/non_cached.rb",
    "lib/cantango/ability_executor/permit_type.rb",
    "lib/cantango/ability_modes_executor.rb",
    ...
    "lib/cantango/categories/loader.rb",
    "lib/cantango/categories/parser.rb",
    ...
    "lib/cantango/permit/execution.rb",
    "lib/cantango/permit/license.rb",
    "lib/cantango/permit/macros.rb",
    "lib/cantango/permit/naming.rb",
    ...
    "lib/cantango/user.rb",
    "lib/cantango/user/guest.rb",
    "lib/cantango/user/macros.rb",
    "lib/cantango/user/masquerade.rb",
    "lib/cantango/user/session_active_user.rb",
    "lib/cantango/user_account.rb",
    "lib/cantango/user_account/active.rb",
    "lib/cantango/user_account/macros.rb",
    "lib/cantango/user_account/masquerade.rb",
    ...
    "spec/cantango/permit_spec.rb",
    "spec/cantango/permit_store_engine_cached_spec.rb",
