...
h2. August 10, RC released!

The first **Release Candidate** of CanTango has now been released, version 0.8.0.rc1
The specs should almost all pass. We also include two working dummy apps (see spec folder) 
The "dummy" app demonstrates how to use CanTango in a Rails 3 app without Devise.
The "devise-dummy" demonstrates integration _with_ Devise :)
