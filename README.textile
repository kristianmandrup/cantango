...
h2. Update August 30, 2011

Currently a few bugs in master. Use the *0.8.4* gem which should use the *sugar-high 0.5* line and work just fine.
Next release will be: *0.8.5* and will contain lots of updtes and improvements, please have patience.

CanTango 0.8.5 will supports "sugar-high 0.6":https://github.com/kristianmandrup/sugar-high.git' where "sweetloader":https://github.com/kristianmandrup/sweet_loader.git' has been extracted into its own gem.
* The Cache is being refactored
...
* Permits will be found and loaded via pre-registration, fx via a new *tango_permit* macro, or by hooking into the @#inherited@ method for the base permits.
