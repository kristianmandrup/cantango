...
* is designed to integrate well with any Role and Authentication systems in a non-intrusive manner.
* supports multiple user accounts and thus works well when you have multiple "Devise":https://github.com/plataformatec/devise users
...
h2. August 17, version 0.8.1 released
