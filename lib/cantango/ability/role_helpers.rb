module CanTango
  class Ability
    module RoleHelpers
      ...
      def roles
        raise "#{subject.inspect} should have a #roles_list method" if !subject.respond_to?(roles_list_meth)
      ...
      def role_groups
        raise "#{subject.inspect} should have a #role_groups_list method" if !subject.respond_to?(role_groups_list_meth)
